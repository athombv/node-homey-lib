...
const capabilityAssets = path.join(__dirname, '..', '..', 'assets', 'capability' );
...
class Capability {
	...
	static getCapabilities() {
  	...
  	const capabilities = require(path.join(capabilityAssets, 'capabilities.json'));
  	capabilitiesCache = capabilities.reduce((obj, capabilityId) => {
      obj[capabilityId] = require(path.join(capabilityAssets, 'capabilities', `${capabilityId}.json`))
