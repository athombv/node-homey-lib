...
class App {
  ...
  async validate({
    ...
    this.constructor.loopObjectRecursive(schema, obj => {
      if (levelPublish && obj['requiredPublish']) obj.required = [...(obj.required || []), ...obj.requiredPublish];
      if (levelVerified && obj['requiredVerified']) obj.required = [...(obj.required || []), ...obj.requiredVerified];
    });
