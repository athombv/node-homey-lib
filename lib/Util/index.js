...
class Util {
  ...
  /**
   * @param {ZigbeeFirmwareUpdates['updates'] | ZwaveFirmwareUpdates['updates']} driverFirmwareUpdatesUpdate
   * @return {driverFirmwareUpdatesUpdate is ZigbeeFirmwareUpdates['updates']}
   */
  ...
  /**
   * @param {ZigbeeFirmwareUpdates['updates'] | ZwaveFirmwareUpdates['updates']} driverFirmwareUpdatesUpdate
   * @return {driverFirmwareUpdatesUpdate is ZwaveFirmwareUpdates['updates']}
   */
